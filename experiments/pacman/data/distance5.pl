...
ghost(40)::ghost(0,  0,  5).
ghost(41)::ghost(0,  0, -5).
ghost(42)::ghost(0, -5,  0).
ghost(43)::ghost(0,  5,  0).
ghost(44)::ghost(0,  1,  4).
ghost(45)::ghost(0,  2,  3).
ghost(46)::ghost(0,  3,  2).
ghost(47)::ghost(0,  4,  1).
ghost(48)::ghost(0, -1,  4).
ghost(49)::ghost(0, -2,  3).
ghost(50)::ghost(0, -3,  2).
ghost(51)::ghost(0, -4,  1).
ghost(52)::ghost(0,  1, -4).
ghost(53)::ghost(0,  2, -3).
ghost(54)::ghost(0,  3, -2).
ghost(55)::ghost(0,  4, -1).
ghost(56)::ghost(0, -1, -4).
ghost(57)::ghost(0, -2, -3).
ghost(58)::ghost(0, -3, -2).
ghost(59)::ghost(0, -4, -1).
...
unsafe_next :- ghost(5, X1, Y1), agent(5, X1, Y1).
